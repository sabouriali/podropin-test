  ...
  return (
    <div className="flex items-start justify-center gap-4">
      <div className="px-4 min-w-sm">
        ...
        <div className="my-2.5 w-full border-b border-gray-200" />
        ...
        <div className="h-10">
          <button className="h-full w-full px-2.5 rounded-lg text-blue-700 border border-blue-700 hover:bg-blue-50 transition-colors cursor-pointer">
            ایجاد حساب کاربری
          </button>
        </div>

        <div className="mb-5 mt-2.5 absolute bottom-0">
