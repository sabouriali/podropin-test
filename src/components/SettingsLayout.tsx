...
function SettingsLayout() {
  return (
    <div className="p-4 flex gap-6 justify-center md:container mx-auto">
      <nav className="p-4 bg-white rounded-2xl w-sm md:w-xs mx-auto md:mx-0 h-[calc(100vh-7.5rem)] sticky top-6 flex-col justify-between hidden md:flex">
